...
# Install MLB Web Content
if [ -f /mnt/usb/Content_Update/install.txt ]; then
	cp -rf /mnt/usb/Content_Update/* /mnt/usb/LibraryBox/Content/
	rm /mnt/usb/LibraryBox/Content/install.txt
	mv /mnt/usb/Content_Update/install.txt /mnt/usb/Content_Update/install.txt.done
	NEEDREBOOT=1
fi
