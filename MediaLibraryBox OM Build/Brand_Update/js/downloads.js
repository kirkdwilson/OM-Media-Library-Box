...
$j_d.getJSON("/dl_statistics_display.php?sortBy=counter&sortOrder=DESC&list_type=all&top-max=10&output_type=json" , function(data) {
    ...
    $j_d.each(data, function() {
        if (decodeURIComponent( this.filename_encoded ) != '') {
             var tbl_row = "";
